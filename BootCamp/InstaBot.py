...
class insta_logger():
    ...
    def get_followers(self,id):
        ...
        sleep(2)
        print(self.browser.find_element_by_xpath('/html/body/div[1]/section/main/div/header/section/ul/li[2]/a/span'))
...
def main():
    ...
    bot=insta_logger('_shyamgupta',"shyaminsta196")
    bot.login_in_func()
